...
From the output, it can be seen that the $H_0:  \mu \leq 31$ is rejected with the p-value of `r klmbinom$p.value` since $H_0: \mu \leq 31$ is not greater than the 50% of the sample since it is located in the first 33% of the data, therefore $H_1 \mu > 31$ is accepted.
...
print(sprintf("W value is %.3ff", t1Wilcox$statistic))
...
print(sprintf("D value is %.3ff", t1Ks$statistic))
```
...
print(sprintf("W value is %.3ff", t2wilcox$statistic))

print(sprintf("Kolmogorov - Smirnov Test - Testing H0 Both samples are from the same population"))
print(sprintf("p-value is %.3f", t2ls$p.value))
print(sprintf("D value is %.3ff", t2ls$statistic))
```
...
print(sprintf("W value is %.3ff", t3wilcox$statistic))

print(sprintf("Kolmogorov - Smirnov Test - Testing H0 Both samples are from the same population"))
print(sprintf("p-value is %.3f", t3ks$p.value))
print(sprintf("D value is %.3ff", t3ks$statistic))
```
