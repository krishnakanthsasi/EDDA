...
In this exercise, effects of silver nitrate to the clouds on rainfoll is investigated. There are two data sets with 26 observations each. In the first section \textit{t}-test, Mann-Whitnet test, and Kolmogorov-Smirnov test are used. In section two, same tests applied to the square root of the data. In the last section, same tests applied to the square root of square rooted data.
