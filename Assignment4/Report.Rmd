...
```{r}
drop1(fruitfliesfullaov,test="F")
```
...
The assumption of normality does not seem to be violated, and the data appears reasonably homoskedastic - the variance of the residuals does not increase greatly for higher fitted values. 
